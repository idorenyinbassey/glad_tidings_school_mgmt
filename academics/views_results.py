...
def result_dashboard(request):
    ...
    return render(request, 'academics/results/dashboard.html', context)
...
def result_entry(request):
    ...
    return render(request, 'academics/results/entry.html', context)
...
def handle_result_entry(request):
    ...
    try:
        with transaction.atomic():
            ...
            messages.success(
                request, 
                f'Results saved successfully! {results_created} new results created, {results_updated} results updated.'
            )
            
    except Exception as e:
        messages.error(request, f'Error saving results: {str(e)}')
    
    return redirect('academics:result_entry')
...
def get_class_students(request):
    ...
    if not all([class_id, session_id, term_id, subject_id, assessment_id]):
    ...
    try:
        ...
        # Get students in the class (you may need to adjust this based on your student-class relationship)
...
def compile_results(request):
    ...
    return render(request, 'academics/results/compile.html', context)
...
def result_sheets(request):
    ...
    return render(request, 'academics/results/sheets.html', context)
...
def bulk_upload_results(request):
    ...
    return render(request, 'academics/results/bulk_upload.html', context)
